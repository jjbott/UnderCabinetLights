...
class Clock
{
  ...
  public:
    static bool TriggerInXSeconds(ulong x, ulong startTime);
    static int TriggerEveryXSeconds(ulong x, ulong& lastTriggeredTime);
    static int TriggerEveryXMillis(unsigned long x, unsigned long &lastTriggeredMicros);
